...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="sticky top-0 grid grid-cols-2 border-b-[1px] border-b-zinc-600 bg-white px-3 py-4 text-black sm:px-8 dark:bg-black dark:text-white">
        <div className="flex items-center gap-4">
          <img className="w-7" src={logo} alt="Logo" />
          <p className="text-lg font-semibold sm:text-xl">Todo App</p>
        </div>

        {authenticate ? (
          <div className="flex justify-end">
            <p
              className="cursor-pointer select-none rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 px-3 py-2 font-medium text-white"
              onClick={toggleMenu}
            >
          ...
          <div className="flex items-center justify-end gap-4 text-base font-medium sm:text-[1.05rem]">
            ...
            <button
              className="rounded-lg bg-black px-3 py-2 text-white hover:bg-gray-300 dark:bg-white dark:text-black"
              type="button"
